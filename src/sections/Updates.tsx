...
import { REGULATORY_UPDATES } from "@/constants/resources";
  ...
  return (
    <SectionLayout id="updates" className="bg-mist">
      <SectionHeader
        ...
        description="Our compliance desk monitors 23 central and state portals every day. Here is what crossed our desk recently."
      />
          ...
          {REGULATORY_UPDATES.map((u, i) => (
            ...
            >
              ...
              <div className="flex-1">
                <div className="text-[0.98rem] font-bold text-navy-900">{u.title}</div>
                <p className="mt-1 text-[0.86rem] leading-[1.7] text-navy-900/60">{u.summary}</p>
              </div>
              <div className="self-start sm:self-center">
                <a href="#" className="text-[0.82rem] font-semibold text-navy-600 hover:underline">
                  Read briefing →
                </a>
              </div>
            </motion.li>
      ...
      <div className="mt-10 text-center">
        <Button href="#" variant="outline">Subscribe to weekly digest</Button>
      </div>
    </SectionLayout>
  );
}
