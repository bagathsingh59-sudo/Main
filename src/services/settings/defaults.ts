...
export const DEFAULT_SETTINGS: SiteSettings = {
  ...
  banner: (() => {
    ...
    return {
      strip: { ...blank },
      popup: { ...blank, showDelaySec: 6, frequency: "session" as const },
      floating: { ...blank, floatingPosition: "bottom-right" as const },
      stickyBar: { ...blank, frequency: "session" as const },
      // Legacy flat fields (back-compat; admin editor no longer touches these)
      enabled: false,
      kind: "strip" as const,
      style: "neutral" as const,
      message: "",
